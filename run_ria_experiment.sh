python phrase_vocabulary_optimization.py --input_file=..\..\dataset\ria\ria.shuffled.train.json --input_format=ria --vocabulary_size=500 --max_input_examples=1000000 --output_file=model\label_map.txt
...
python run_lasertagger.py --training_file=model\ria_train.tf_record --eval_file=model\ria_test.tf_record --label_map_file=model\label_map.txt --model_config_file=configs\lasertagger_config.json --output_dir=model\models\ria_first_experiment --do_train=true --do_eval=true --train_batch_size=256 --num_train_examples=43671 --num_eval_examples=49938 --init_checkpoint=..\..\model\bert\rubert_cased_L-12_H-768_A-12_v2\bert_model.ckpt --save_checkpoints_steps=500