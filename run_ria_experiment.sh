...
python run_lasertagger.py --training_file=model\ria_train.tf_record --eval_file=model\ria_test.tf_record --label_map_file=model\label_map.txt --model_config_file=configs\lasertagger_config.json --output_dir=model\models\ria_first_experiment --do_train=true --do_eval=true --train_batch_size=256 --num_train_examples=43671 --num_eval_examples=49938